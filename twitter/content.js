...
playerManager.add(new Player("RafaelNadal", "ラファエル・ナダル", ["Rafael", "Nadal"]));
...
playerManager.add(new Player("CarolZhao95", "キャロル・ザオ", ["carol", "zhao"]));
...
playerManager.add(new Player("SvetlanaK27", "スベトラーナ・クズネツォワ", ["Svetlana", "Kuznetsova"]));
